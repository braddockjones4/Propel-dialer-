...
- `BACKEND_URL` = `https://propel-dialer-backend.onrender.com`
- `ENCRYPTION_KEY` (auto-generated by Render if using the `render.yaml` blueprint)
- `GOOGLE_CLIENT_ID` / `GOOGLE_CLIENT_SECRET` (for Gmail connect)

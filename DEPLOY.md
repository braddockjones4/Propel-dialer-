...
| `ANTHROPIC_MODEL` | Optional — Claude model id for the AI chat assistant, defaults to `claude-haiku-4-5-20251001` if unset |
| `BACKEND_URL` | `https://propel-dialer-backend.onrender.com` — used to build Twilio webhook URLs |
| `ENCRYPTION_KEY` | Auto-generated by Render (AES-256 key for iCloud credential encryption) |
| `GOOGLE_CLIENT_ID` | From Google Cloud Console OAuth client (Gmail connect) |
| `GOOGLE_CLIENT_SECRET` | From Google Cloud Console OAuth client (Gmail connect) |
